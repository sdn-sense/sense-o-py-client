...
from .exceptions import ParseConfigException
...
class Parser:
    ...
    def _validate_providers(providers: List[ProviderConfig]):
        ...
        from .exceptions import ProviderTypeNotSupported
    ...
    def _validate_configs(configs: List[Config]):
        from .exceptions import ConfigTypeNotSupported
    ...
    def _validate_resources(resources: List[ResourceConfig]):
        ...
        from .exceptions import ResourceTypeNotSupported
