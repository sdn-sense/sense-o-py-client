...
from sense.workflow.controller_helper import ControllerResourceListener, partition_layer3_config, populate_layer3_config
from sense.workflow.provider_factory import ProviderFactory, default_provider_factory
...
class Controller:
    ...
    def init(self, *, session: str,
        ...
        networks = [resource for resource in self.resources if resource.is_service]
